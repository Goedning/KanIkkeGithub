...
namespace SpaceInvaders {
    public partial class SinglePlayerForm : Form {
        ...
        private double speedMultiplier = 1; // Hurtigere når vi dræber aliens
        private int numAliensLeft = 55; // Hvor mange aliens der er tilbage
        private int score = 0; // Styrer vores score
        ...
        private int totalProjectiles = 0; // Hvor mange alien skud er aktive
        ...
        private void CheckEndGame() 
        {
            ...
            if (numAliensLeft == 0) {
                ...
                projectileCollision.Enabled = false;
                Thread.Sleep(1000);
                SinglePlayerForm NewForm = new SinglePlayerForm(); 
        ...
        private void TryShoot() 
        {
            foreach (var alien in BottomAliens) {
                if ((alien.GetState() == 1) && totalProjectiles <= 3) { // Begræsning for hvor mange alien skud der kan være på en gang
